...
from aerial_gym.task.racing_task.racing_task import RacingTask
from aerial_gym.config.task_config.racing_task_config import (
    task_config as racing_task_config,
)
from aerial_gym.task.racing_task.evaluation_task import EvaluationTask
from aerial_gym.config.task_config.evaluation_task_config import (
    task_config as evaluation_task_config,
)
...
task_registry.register_task("racing_task", RacingTask, racing_task_config)

task_registry.register_task("evaluation_task", EvaluationTask, evaluation_task_config)
